...
<body class="bg-gray-100 p-6">
    ...
    <div class="max-w-6xl mx-auto">
        ...
        <div class="mb-4 space-x-2">
            ...
            <a href="/dashboard?view=trash" class="bg-red-600 text-white px-4 py-2 rounded">
                🗑 Trash
            </a>
        ...
        @if(!request('view') || request('view') != 'trash')
            ...
            <div class="bg-white p-4 rounded shadow mb-6">
                <form method="POST" action="/run">
                    ...
                    <input name="command" class="border p-3 w-full rounded"
                        placeholder="Enter Laravel / PHP command (e.g. User::count())" required />
        ...
        <div class="bg-white p-4 rounded shadow mb-6">
            <form method="GET" class="flex gap-2">
                ...
                <input name="search" class="border p-2 flex-1 rounded" placeholder="Search commands..." />
                        ...
                        <tr class="border-b hover:bg-gray-50">
                            ...
                            <td class="p-3 space-x-2">
                                ...
                                @if(request('view') != 'trash')
                                    ...
                                    <a href="/favorite/{{ $cmd->id }}" class="text-yellow-500 hover:underline">
                                        ⭐ Toggle
                                    </a>

                                    <a href="/delete/{{ $cmd->id }}" class="text-red-500 hover:underline">
                                        Delete
                                    </a>
                                ...
                                @else
                                    ...
                                    <!-- TRASH MODE ACTION -->
                                    <a href="/restore/{{ $cmd->id }}" class="text-green-500 hover:underline">
                                        ♻ Restore
                                    </a>
